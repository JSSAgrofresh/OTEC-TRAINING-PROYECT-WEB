...
import instructorsTeam from '../../assets/img/instructores-torre.jpg';
      ...
      <div className="container split-layout split-layout--reverse">
        <div className="split-media reveal" data-reveal data-reveal-dir="right" ref={mediaRef}>
          <div className="media-frame">
            <img
              src={instructorsTeam}
              alt="Instructores de OTEC Training Proyect supervisando una maniobra de rescate en la torre de altura física"
              loading="lazy"
            />
          </div>
        </div>
