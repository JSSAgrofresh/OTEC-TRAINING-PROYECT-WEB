...
const CERTS = [
  {
    tag: 'Única en Latinoamérica',
    title: 'Licencia ANSI/ASSP Z359 — Protección Contra Caídas',
    text: 'En agosto de 2024, OTEC Training Proyect SpA obtuvo a nivel LATAM la licencia de Protección Contra Caídas ANSI Z359, otorgada por la American Society of Safety Professionals (ASSP), certificando a sus instructores como los únicos en toda Latinoamérica con esta acreditación.',
    highlight: true,
  },
  {
    tag: 'Desde 2014',
